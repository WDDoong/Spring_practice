...
// 따라서 로그를 찍을 때 System.out.println();를 쓰는 건 권장되지 않습니다.
...
public class OjdbcConnectionTest {
	...
	// 이 클래스파일을 실행했을 때, @Test가 붙은 매서드만 실행합니다.
	@Test
	public void testConnection() {
		try (Connection con = DriverManager.getConnection(
			...
			// 접속이 정상적이지 않을때 풀력한 내용을 아래에 작성합니다.
			// fail함수를 이용해 우측 failure Trace에 메세지를 띄웁니다.
			fail(e.getMessage());
		}
	}
	@Test
